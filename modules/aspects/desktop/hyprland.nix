...
{
  den.aspects.desktop._.hyprland = den.lib.parametric {
        ...
        in
        {
          ...
          homeManager =
            ...
            let
              ...
              toggleTransparent = pkgs.writeShellScriptBin "toggle-transparent" ''
                get_option() {
              ...
              wayland.windowManager.hyprland = {
                ...
                settings = {
                  ...
                  bind = [
                    ...
                    "$mod, Z, togglespecialworkspace, mincontainer"
                    "$mod, H, exec, ${toggleTransparent}/bin/toggle-transparent"
                    "Alt_L, H, movefocus, l"
                    "Alt_L, J, movefocus, d"
                    "Alt_L, K, movefocus, u"
                    "Alt_L, L, movefocus, r"
